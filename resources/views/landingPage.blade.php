...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="pt-24">
        <div class="container px-3 mx-auto flex flex-wrap md:flex-nowrap items-center">
            <!-- Left Col -->
            <div class="flex flex-col w-full md:w-3/5 justify-center items-start text-center md:text-left mb-6 md:mb-0">
            ...
            <div class="w-full md:w-2/5 py-6 text-center">
                <img class="w-full md:w-4/5 z-50"
                    src="{{ asset('http://localhost:8000/storage/undraw_start_building_re_xani.svg') }}" />
            </div>
        </div>
